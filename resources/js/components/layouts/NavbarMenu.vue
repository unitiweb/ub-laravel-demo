    ...
    <transition enter-active-class="transition ease-out duration-100"
        ...
        <div class="bg-light-blue-900 lg:hidden">
            <div class="pt-2 pb-3 px-2 space-y-1">
                <navbar-menu-link :to="{ name: 'dashboard' }">Dashboard</navbar-menu-link>
                <navbar-menu-link :to="{ name: 'login' }">Jobs</navbar-menu-link>
                <navbar-menu-link :to="{ name: 'login' }">Applications</navbar-menu-link>
                <navbar-menu-link :to="{ name: 'login' }">Company</navbar-menu-link>
            </div>
